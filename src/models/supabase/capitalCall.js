...
class CapitalCall {
  ...
  static async findWithAllocations(capitalCallId) {
    ...
    capitalCall.capital_call_allocations = allocations.map(a => ({
      ...
      principalAmount: parseFloat(a.principal_amount) || 0,
      management_fee_gross: parseFloat(a.management_fee_gross) || 0,
      managementFeeGross: parseFloat(a.management_fee_gross) || 0,
      management_fee_discount: parseFloat(a.management_fee_discount) || 0,
      managementFeeDiscount: parseFloat(a.management_fee_discount) || 0,
      management_fee_net: parseFloat(a.management_fee_net) || 0,
      managementFee: parseFloat(a.management_fee_net) || 0,
      managementFeeNet: parseFloat(a.management_fee_net) || 0,
      // Dual-rate fee breakdown
      nic_fee_amount: parseFloat(a.nic_fee_amount) || 0,
      nicFeeAmount: parseFloat(a.nic_fee_amount) || 0,
      unfunded_fee_amount: parseFloat(a.unfunded_fee_amount) || 0,
      unfundedFeeAmount: parseFloat(a.unfunded_fee_amount) || 0,
      fee_offset_amount: parseFloat(a.fee_offset_amount) || 0,
      feeOffsetAmount: parseFloat(a.fee_offset_amount) || 0,
      deemed_gp_contribution: parseFloat(a.deemed_gp_contribution) || 0,
      deemedGpContribution: parseFloat(a.deemed_gp_contribution) || 0,
      ...
      // ProximityParks breakdown
      investments_amount: parseFloat(a.investments_amount) || 0,
      investmentsAmount: parseFloat(a.investments_amount) || 0,
      fund_expenses_amount: parseFloat(a.fund_expenses_amount) || 0,
      fundExpensesAmount: parseFloat(a.fund_expenses_amount) || 0,
      reserves_amount: parseFloat(a.reserves_amount) || 0,
      reservesAmount: parseFloat(a.reserves_amount) || 0,
      total_drawdown: parseFloat(a.total_drawdown) || 0,
      totalDrawdown: parseFloat(a.total_drawdown) || 0,
      vat_on_investments_amount: parseFloat(a.vat_on_investments_amount) || 0,
      vatOnInvestmentsAmount: parseFloat(a.vat_on_investments_amount) || 0,
      vat_on_fund_expenses_amount: parseFloat(a.vat_on_fund_expenses_amount) || 0,
      vatOnFundExpensesAmount: parseFloat(a.vat_on_fund_expenses_amount) || 0,
