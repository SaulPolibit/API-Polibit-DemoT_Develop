...
class Structure {
  ...
  static _toModel(dbData) {
    ...
    return {
      ...
      confidentiality: dbData.confidentiality,
      ...
      localTaxId: dbData.local_tax_id,
      ...
      distributionModel: dbData.distribution_model,
      ...
      // ILPA Phase 3-5: Fee structure + Payment methods
      postCommitmentFeeRate: dbData.post_commitment_fee_rate,
      flatManagementFeeRate: dbData.flat_management_fee_rate,
      managementFeeOffset: dbData.management_fee_offset,
      feeOffsetRate: dbData.fee_offset_rate,
      prefReturnCompounding: dbData.pref_return_compounding,
      payWithPolibitEnabled: dbData.pay_with_polibit_enabled,
      payWithPolibitSettlement: dbData.pay_with_polibit_settlement,
      paymentCardEnabled: dbData.payment_card_enabled,
      // Spec V2: Recallable Distributions (Step 4)
