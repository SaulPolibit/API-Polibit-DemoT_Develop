...
function generateThemePalette(themeConfig) {
  ...
  const lightVars = {
    ...
    // Near-neutrals — subtle hue tint for warm/cool temperature
    '--secondary': oklch(0.967, 0.003, h),
    '--secondary-foreground': oklch(0.210, 0.008, h),
    '--accent': oklch(0.967, 0.003, h),
    '--accent-foreground': oklch(0.210, 0.008, h),
    '--muted': oklch(0.967, 0.003, h),
    '--muted-foreground': oklch(0.552, 0.010, h),
    '--sidebar-accent': oklch(0.967, 0.003, h),
    '--sidebar-accent-foreground': oklch(0.210, 0.008, h),
    '--border': oklch(0.920, 0.005, h),
    '--input': oklch(0.920, 0.005, h),
    '--sidebar-border': oklch(0.920, 0.005, h),
  };
  ...
  const darkVars = {
    ...
    '--muted-foreground': oklch(0.705, 0.010, h),
